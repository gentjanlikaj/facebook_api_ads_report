...
def get_data(account):
    ...
    for ad in x:
        ...
        if ('publisher_platform' in ad) :
            publisher_platform = ad['publisher_platform']
        if ('platform_position' in ad) :
            platform_position = ad['platform_position']
        if ('impression_device' in ad) :
            impression_device  = ad['impression_device']
        if ('date_start' in ad) :
    ...
    file_name = account + '_' +'other_breakdown.csv'
